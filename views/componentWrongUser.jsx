        ...
        return (
            ...
            <div style={{display: 'flex', alignItems: "center"}}>
                ...
                <form method="POST" action="/login" style={{width: '300px', display: 'block'}}>
                    ...
                    <input name="username" className="text-center" placeholder="Wrong Username!!!" style={{width: '300px', color: 'red !important', textAlign: 'left', display: 'block', margin: '15px 0', height: '50px'}}/>
