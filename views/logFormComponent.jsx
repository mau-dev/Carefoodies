            ...
            <div style={{display: 'flex', alignItems: "center"}}>
                <form method="POST" action="/login" style={{width: '300px', display: 'block'}}>
                    ...
                    <input name="password" className="text-center " placeholder="Password" style={{width: '300px', display: 'block', margin: '15px auto', height: '50px'}}/>
                     <input type="submit"  method="GET" action="/login" value= "Log In" className="btn btn-block" style={{width: '300px', display: 'block', margin: '10px auto', height: '50px', borderRadius: '8px', backgroundColor: '#CC46E0', color: 'white'}}/>
                </form>
            </div>
    );
}
