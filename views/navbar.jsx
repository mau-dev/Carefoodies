                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul className="nav mr-auto mt-lg-0">
                                    <li className="nav-item">
                                        <a className="nav-link" style={{ color: '#CC46E0'}} href="http://localhost:3000/posts/">See All Posts</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link" style={{ color: '#CC46E0'}} href="http://localhost:3000/posts/new">Post Food</a>
                                    </li>
                                 </ul>
