        ...
        return (
            ...
            <div style={{display: 'block', margin: '15% 3%'}}>
                <form method="POST" action="/register" style={{width: '300px', display: 'block'}}>
                    ...
                    <input type="submit" value= "Register" action="/login" class="btn btn-block" style={{width: '300px', display: 'block', margin: '10px auto', height: '50px', borderRadius: '8px', backgroundColor: '#CC46E0', color: 'white'}}/>
                 </form>
            </div>
