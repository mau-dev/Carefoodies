           ...
           <html>
                ...
                <body>
                    <div className="container-fluid" style={{ padding:'0'}}>
                        <nav className="navbar navbar-expand-lg navbar-inverse bg-inverse px-md-5 px-4 py-md-3 py-3" style={{  borderBottom: '1px solid #E3E3E1', backgroundColor: 'white',fontFamily: 'Montserrat'}}>
