           ...
           <html>
                ...
                <body>
                    <div className="container-fluid" style={{ padding:'0'}}>
                        <nav className="navbar navbar-expand-lg navbar-inverse bg-inverse" style={{ padding: '10px 50px', borderBottom: '1px solid #E3E3E1', backgroundColor: 'white',fontFamily: 'Montserrat'}}>
