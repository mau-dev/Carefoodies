...
class Register extends React.Component {
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
                        <h1 style={{color: '#CC46E0', margin: '0 auto ',  fontSize: '86px', fontWeight: '900', borderBottom: '25px solid #5CE048'}}>Share</h1>
                        <h1 style={{color: '#CC46E0', margin: '0 auto ', fontSize: '86px', fontWeight: '900', borderBottom: '25px solid #5CE048'}}>Excess
                        </h1>
                        <h1 style={{color: '#CC46E0', margin: '0 auto 2% auto ',  fontSize: '86px', fontWeight: '900', borderBottom: '25px solid #5CE048'}}>Food
                        </h1>
                        <p style={{paddingLeft: '30%', fontSize: '18px'}}>Share the food you don’t need instead of throwing it away and help other people while helping the environment</p>

    </div>
    <div className="carousel-item">
                        <h1 style={{color: '#CC46E0', margin: '0 auto ',  fontSize: '86px', fontWeight: '900', borderBottom: '25px solid #5CE048'}}>Find
                        </h1>
                        <h1 style={{color: '#CC46E0', margin: '0 auto ', fontSize: '86px', fontWeight: '900', borderBottom: '25px solid #5CE048'}}>Free
                        </h1>
                        <h1 style={{color: '#CC46E0', margin: '0 auto 2% auto ',fontSize: '86px', fontWeight: '900', borderBottom: '25px solid #5CE048'}}>Food
                        </h1>
